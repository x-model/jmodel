...
export function partial<T1 extends ExecutionContext & BuilderPartialContext>(
  s1: BuilderStepConfig<Unwrap<ExecutionContext>, T1>
): <Context>(context: Context) => Context & T1;
...
): <Context>(context: Context) => Context & T2;
...
): <Context>(context: Context) => Context & T3;
...
): <Context>(context: Context) => Context & T4;
